...
export default function Nav({ name = 'Shoply' }) {
  ...
  return (
    <header className="sticky top-0 z-30 border-b border-zinc-200/80 bg-white/95 backdrop-blur-md">
      <div className="mx-auto grid h-16 max-w-6xl grid-cols-[1fr_auto_1fr] items-center gap-3 px-5 sm:h-[4.25rem] sm:px-6">
        {/* Left: brand */}
        <div className="flex min-w-0 items-center justify-start">
          <Link
            ...
            onClick={close}
          >
            <span className="flex h-8 w-8 items-center justify-center rounded-lg bg-zinc-900 text-sm font-bold text-white transition group-hover:bg-rose-600">
              S
            </span>
        ...
        <div className="flex items-center justify-end gap-1 sm:gap-1.5">
          ...
          {/* Far right: back to portfolio home */}
          <Link
            to="/"
            className="ml-1 inline-flex h-10 items-center gap-1.5 rounded-full border border-zinc-200 bg-white px-3 text-sm font-semibold text-zinc-700 no-underline transition hover:border-zinc-300 hover:bg-zinc-50 hover:text-zinc-900 sm:px-3.5"
            title="Back to home"
          >
